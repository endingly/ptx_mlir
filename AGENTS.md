...
- [.github/CONTRIBUTING.md](.github/CONTRIBUTING.md) describes the CI workflows
  and cache ownership rules. Keep it aligned when a workflow changes.
- Reusable build components under [cmake/](cmake/) document their own call
  contract in a header comment; keep that comment current with the function.
